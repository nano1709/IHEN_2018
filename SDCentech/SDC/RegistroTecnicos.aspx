<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario.Master" AutoEventWireup="true" CodeBehind="RegistroTecnicos.aspx.cs" Inherits="SDC.RegistroTecnicos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="product-screen-1 wow fadeInLeft" runat="server" data-wow-delay="0.1s" data-wow-duration="0.1s">
        <div id="divClientes" class="form-group" runat="server" visible="true">
            ...
            <h3 style="color: #308ED5; margin-left: 10px;">Registro de técnicos</h3>
            <table class="table-condensed" style="border: thin solid #308ED5; margin-right: 0px; margin-left: 10px;">
                ...
                <tr>
                    <td style="margin: 10px 9px 7px 9px; padding: 10px 9px 7px 9px;">
                        ...
                        <asp:TextBox ID="txtCodigoTecnico" runat="server" placeholder="Código Técnico" class="form-control" Width="450px"></asp:TextBox>
