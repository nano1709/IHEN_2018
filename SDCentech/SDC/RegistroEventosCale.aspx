            ...
            <div style="text-align: center;">
                <table class="table-condensed" style="margin: 0 auto; border: thin solid #308ED5;">
                    ...
                    <tr>
                        ...
                        <td style="margin: 10px 9px 7px 9px; padding: 10px 9px 7px 9px;">
                            <asp:Label ID="lblColor" runat="server" Text="Identificaci{on de Color: " ForeColor="#308ED5"></asp:Label>
                            <asp:DropDownList ID="txtColor" runat="server" placeholder="Objetivo del curso" class="form-control" Width="320px">
                    ...
                    <tr>
                        <td style="margin: 10px 9px 7px 9px; padding: 10px 9px 7px 9px;">
                            ...
                            <input type="date" id="txtFechaInicio" runat="server" class="auto-style4" />

                        <td style="margin: 10px 9px 7px 9px; padding: 10px 9px 7px 9px;">
                            <asp:Label ID="lblfechaFinal" runat="server" Text="Fecha Final:" ForeColor="#308ED5"></asp:Label><br />
                            <input type="date" id="txtFechaFinal" runat="server" class="auto-style4" />
                    </tr>
